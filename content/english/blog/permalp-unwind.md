---
title: "PermaLP Position Unwinding Report"
...
The DeFi Collective has unwound its permaLP liquidity initiative. This post is a comprehensive report on this two-years adventure which will explain why and provide all the receipts. This initiative was conducted with four projects in total: [Liquity](https://www.liquity.org/) v2 BOLD (through a PIL initiative) \- on BOLD, [Possum Finance](https://www.possum.finance/) \- on PSM, [PoolTogether](https://pooltogether.com/) \- on POOL and [Botto](https://botto.com/dao) \- on BOTTO.
...
However, there is one positive lesson to be learned from this decision, namely that the Collective's treasury management was never questioned in the decision to discontinue the perma-LP. Our [Treasury Management Policy](https://deficollective.org/treasury-management-policy/) has remained unchanged since the Collective was founded, and without it, the situation would have been much more difficult.
...
Today, the [Possum Finance project still exists in the form of a no-loss prediction market](https://www.possum.finance/), and the PSM token still exists.
...
Before BOLD even launched, the Collective set aside **100 ETH specifically to mint BOLD** immediately after the protocol went live, and the treasury management team devised a [clear allocation strategy](https://voting.liquity.org/t/the-defi-collective-bold-liquidity-initiative-maximize-bold-footprint-on-l2s/15) for the BOLD Liquidity initiative they created for Liquity’s Protocol Incentivized Liquidity:
...
2. The Collective recovered its pairing asset component (often with sizable IL) and sent it to [its main wallet](https://debank.com/profile/0x6665e62ef6f6db29d5f8191fbac472222c2cc80f).  
3. The assets stemming from donations were consolidated into [the grants wallet](https://debank.com/profile/0xDc6f869d2D34E4aee3E89A51f2Af6D54F0F7f690).  
4. We reached out to each concerned community to determine what was the best course of actions for these assets.

### Liquity v2 \- BOLD

Per our [BOLD PIL Strategy](https://deficollective.org/blog/bold-strategy/), half of the assets received from the Liquity v2 PIL system were matched with stablecoins from the Collective treasury, and supplied as permaLP on Velodrome and Aerodrome.

The LP position have been withdrawn, resulting in the recovery of 62 375.41 BOLD, [sent to the grants wallet](https://etherscan.io/tx/0x857847f554ac0067fac57e853436cd57dd8cd7b50364691eac13afe722f18311).
...
[First PIL+Merkl re-injection – March 12](https://etherscan.io/tx/0xdbfb3ba83c191faae50ec0fd369a6ea63995324f6cc0ec94a1230259d49c8b80)
...
![vote-example](https://raw.githubusercontent.com/deficollective/deficollective.github.io/main/assets/images/permalp-unwind-vote-example.png)
...
We’ve reached out to the PoolTogether community and discussed what would be the most appropriate course of action with the \~418k POOL concerned. The community voted burn. We decided to round the number up to 420K POOL using our own reserve for maximal fun factor, and [proceeded with the burn on March 12](https://etherscan.io/tx/0xbfa1a4931bb5a8ddb7bf40507285131be288e3d41293ba916b99872d96b5baca).

### Possum Finance \- PSM

With the community’s avail, the Collective retained the whole position and bridged it back to mainnet on [its main wallet](https://debank.com/profile/0x6665e62ef6f6db29d5f8191fbac472222c2cc80f). 

### BOTTO

A total of 223 000 BOTTO was remaining, and here we operated a fair split:

1. [100 000 BOTTO were burned](https://etherscan.io/tx/0x259e88a08e5e48b53fd01b5d8cc1b03a09dc910da074a74b6b76f0ad75a34ad4)  
2. [70 000 were allocated to a key contributor in the Collective x Botto collaboration](https://etherscan.io/tx/0x3671dd321e622383169b51dc1bcddb518938730f910966588b1a4d5109c105dc).  
3. [The Collective kept the remaining 53 566.9585 and staked them with the main wallet.](https://etherscan.io/tx/0xcf857fd84de9e2fd544c318915c5a384073df10b8b1772b55d982800a8e85b26)
